...
<body data-bs-spy="scroll" data-bs-target="#navbarExample">
    ...
    <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
        <div class="container">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                ...
                @else
                <span class="nav-item">
                    <a class="btn btn-danger" href="{{ route('login') }}" >Masuk Akun</a>
                </span>
                @if (Route::has('register'))
                <span class="nav-item">
                    <a class="btn btn-danger" href="{{ route('register') }}">Daftar Akun</a>
                </span>
                @endif
                @endauth
                @endif
            ...
            <div class="row">
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
                        ...
                        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                            ...
                            @else
                            <a href="{{ route('login') }}" class="btn btn-danger">Masuk Akun</a>
                            @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="btn btn-danger">Daftar Akun</a>
                            @endif
                            @endauth
                        </div>
                        @endif
                ...
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="{{ asset('zinc') }}/images/4807606_2529134.jpg"
                            alt="alternative">
    ...
    <div class="footer bg-white mt-5">
        <img class="img-fluid" src="{{ asset('zinc') }}/images/Indonesia landmark.jpg" alt="alternative">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
